...
def generate_pages_recursive(from_path, template_path, dest_path):
    # get content directory file list and crawl each folder for markdown files.
    # for each markdown file found, generate a new .html file using the template.html
        # the generated pages should be written to the public folder in the same directory structure
    # change the main function to use the recursive version so that all md files in the source path are recursively constructed.
